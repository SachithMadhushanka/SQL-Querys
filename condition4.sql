--If Rajagiriya’s Qty are higher than Elpitiya’s or Mahabage’s Qty, and Rajagiriya’s stock is less than Elpitiya’s or Mahabage’s stock.
...
WHERE 
    (RajagiriyaQty > ElpitiyaQty OR RajagiriyaQty > MahabageQty)
    AND (RajagiriyaStock < ElpitiyaStock OR RajagiriyaStock < MahabageStock)
